...
класс объекта сообщения события
**публичные свойства**
| Свойство          | Тип   | Описание          |
|-------------------|-------|-------------------|
| readonly $message | mixed | сообщение события |

### Interface app\components\ObserverInterface
интерфейс классов объектов слушателей событий
**методы**
| Метод     | Входящие типы                                       | Возвращаемый тип | Описание                      |
|-----------|-----------------------------------------------------|------------------|-------------------------------|
...
класс объекта диспетчера событий
**публичные методы**
| Метод     | Входящие типы                                                                                 | Возвращаемый тип | Описание                            |
|-----------|-----------------------------------------------------------------------------------------------|------------------|-------------------------------------|
| attach()  | app\components\Event $event - событие, app\components\ObserverInterface $observer - подписчик | void             | добавить подписчика на событие      |
| detach()  | app\components\Event $event - событие                                                         | void             | удалить всех подписчиков на событие |
| trigger() | app\components\Event $event - событие, app\components\Message $message - сообщение события    | void             | оповестить подписчиков о событии    |

### Class app\observers\ObserveConsoleGatewayEnd
класс объекта слушателя события `GATEWAY_DONE`  
**публичные методы:**  
см. интерфейс app\components\ObserverInterface
